...
class Campaign extends Controller {
    ...
    public function delete() {
        ...
        if(!$campaign_id = db()->where('campaign_id', $campaign_id)->where('user_id', $this->user->user_id)->getValue('campaigns', 'campaign_id')) {
            redirect('dashboard');
        }
        ...
        if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
            ...
            Alerts::add_success(language()->campaign_delete_modal->success_message);
