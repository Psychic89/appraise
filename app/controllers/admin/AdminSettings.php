                ...
                foreach($settings_keys as $key => $value) {
                    ...
                    if(is_array($value)) {
                        ...
                        foreach($value as $sub_key) {
                            ...
                            if(!in_array($key . '_' . $sub_key, ['announcements_content', 'custom_head_css', 'socialproofo_branding', 'custom_head_css', 'custom_head_js', 'ads_header', 'ads_footer', 'offline_payment_instructions'])) {
