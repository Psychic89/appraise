    ...
    <div class="mb-3 mb-xl-5 mb-xl-0 col-12 col-xl-3">
        <div class="d-xl-none">
            <select name="settings_menu" class="form-control">
                ...
                <option value="#socialproofo" class="nav-link"><?= language()->admin_settings->tab->socialproofo ?></option>
        ...
        <div class="nav flex-column nav-pills d-none d-xl-flex" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link" href="#socialproofo" data-toggle="pill" role="tab"><i class="fa fa-fw fa-sm fa-share-alt mr-1"></i> <?= language()->admin_settings->tab->socialproofo ?></a>
                ...
                <form action="" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="socialproofo">
                            <div class="form-group">
                                <label for="socialproofo_branding"><?= language()->admin_settings->socialproofo->branding ?></label>
                                <textarea id="socialproofo_branding" name="socialproofo_branding" class="form-control form-control-lg"><?= settings()->socialproofo->branding ?></textarea>
                                <small class="form-text text-muted"><?= language()->admin_settings->socialproofo->branding_help ?></small>
                            </div>

                            <div class="form-group">
                                <label for="socialproofo_analytics_is_enabled"><i class="fa fa-fw fa-sm fa-chart-bar text-muted mr-1"></i> <?= language()->admin_settings->socialproofo->analytics_is_enabled ?></label>
                                <select id="socialproofo_analytics_is_enabled" name="socialproofo_analytics_is_enabled" class="form-control form-control-lg">
                            ...
                            <div class="form-group">
                                <label for="socialproofo_pixel_cache"><?= language()->admin_settings->socialproofo->pixel_cache ?></label>
                                <input id="socialproofo_pixel_cache" type="number" min="0" name="socialproofo_pixel_cache" class="form-control form-control-lg" value="<?= settings()->socialproofo->pixel_cache ?>" />
