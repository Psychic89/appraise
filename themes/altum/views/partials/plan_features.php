...
<ul class="list-style-none m-0">
    ...
    <li class="d-flex align-items-baseline mb-2">
        ...
        <div class="<?= $data->plan_settings->removable_branding ? null : 'text-muted' ?>">
            <?= language()->global->plan_settings->removable_branding ?>
        </div>
    </li>
    ...
    <li class="d-flex align-items-baseline mb-2">
        ...
        <div class="<?= $data->plan_settings->custom_branding ? null : 'text-muted' ?>">
            <?= language()->global->plan_settings->custom_branding ?>
        </div>
    </li>
    ...
    <li class="d-flex align-items-baseline mb-2">
        ...
        <div class="<?= $data->plan_settings->campaigns_limit ? null : 'text-muted' ?>">
            <?php if($data->plan_settings->campaigns_limit == -1): ?>
                <?= language()->global->plan_settings->unlimited_campaigns_limit ?>
            <?php else: ?>
                <?= sprintf(language()->global->plan_settings->campaigns_limit, '<strong>' . nr($data->plan_settings->campaigns_limit) . '</strong>') ?>
            <?php endif ?>
        </div>
    </li>
    ...
    <li class="d-flex align-items-baseline mb-2">
        ...
        <div class="<?= $data->plan_settings->notifications_limit ? null : 'text-muted' ?>">
            <?php if($data->plan_settings->notifications_limit == -1): ?>
                <?= language()->global->plan_settings->unlimited_notifications_limit ?>
            <?php else: ?>
                <?= sprintf(language()->global->plan_settings->notifications_limit, '<strong>' . nr($data->plan_settings->notifications_limit) . '</strong>') ?>
            <?php endif ?>
        </div>
    </li>
    ...
    <li class="d-flex align-items-baseline mb-2">
        ...
        <div class="<?= $data->plan_settings->notifications_impressions_limit ? null : 'text-muted' ?>">
            <?php if($data->plan_settings->notifications_impressions_limit == -1): ?>
                <?= language()->global->plan_settings->unlimited_notifications_impressions_limit ?>
            <?php else: ?>
                <?= sprintf(language()->global->plan_settings->notifications_impressions_limit, '<strong>' . nr($data->plan_settings->notifications_impressions_limit) . '</strong>') ?>
            <?php endif ?>
        </div>
    </li>
